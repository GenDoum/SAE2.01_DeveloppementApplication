...
namespace Persistance
{
    ...
    public class LoaderStub : IUserDataManager
    {
        ...
        public List<Monstre> loadMonsters() ///SAME
        {
            ...
            lm.Add(new Monstre(8, "Loup", "passif", "Je deviens vite aggressif lorsque l'on m'attaque.", new List<string> { "Les loups peuvent être apprivoisé grâce à des os.", " Une fois apprivoisé" }, new List<string> { "Apparence nature", "Apparence méchant", "Apparence apprivoisé" }, new List<Modèle.Conseil> { }));
            lm.Add(new Monstre(9, "Chat", "passif", "J'espère que tu as du poisson, sinon je ne m'approche pas de toi !", new List<string> { "Le chat à peur des humain mais apparaît seulement dans les villages.", "Si un chat apparaît près d'une sorcière, il sera forcément noir" }, new List<string> { "apparence au pif", "apparence noir" }, new List<Modèle.Conseil> { }));
            lm.Add(new Monstre(10, "Zombie", "hostile", "Je peux vous voir de très loin et venir discrètement.", new List<string> { "Il y a une faible chance qu'un zombie qui apparaît soit un zombie villageois, il est possible de le re transformer en villageois afin de faire des échanges à prix réduit avec lui", "Les bébé zombie sont les monstres les plus rapides." }, new List<string> { "Zobmie", "zombie villageois", " bébé zombie" }, new List<Modèle.Conseil> { }));
            lm.Add(new Monstre(11, "Squelette", "hostile", "Je suis un sniper d'élite, je ne loupe presque jamais ma cible", new List<string> { "Il laisse parfois tomber leurs arc, mais ils sont souvent usés.", " Parfois il chevauche une araignée pour se déplacer, il devient alors plus rapide." }, new List<string> { "basique", "spider jokey" }, new List<Modèle.Conseil> { }));
            lm.Add(new Monstre(12, "Creeper", "hostile", "J'approche doucement et j'explose.", new List<string> { "Le creeper possède une peau verte et blanche. Cette apparence était à l'époque de la bêta du jeu la même que les blocs de terre, afin de surprendre les joueurs.", "Il est possible de le faire exploser avec un briquet" }, new List<string> { "apparence de base" }, new List<Modèle.Conseil> { }));
            lm.Add(new Monstre(13, "Phantom", "hostile", "Dormez ou je viendrais", new List<string> { "Le phantom apparaît lorsque vous ne dormez pas pendant plus de trois jour d'affilés.", "Ils sont difficile à atteindre pusiqu'il vole plutôt vite" }, new List<string>{"Apparence 1"}, new List<Modèle.Conseil> { }));
            lm.Add(new Monstre(14, "Enderman", "hostile", "Ne me regardez pas ! ", new List<string> { "Si vous regardez un enderman dans les yeux, il se mettra à vous attaquer, autrement, il est inoffensif", " Gardez le contact visuel avec, lui le fera changer d'avis au bout de quelques secondes sur l'agressivité qu'il a envers vous.", "Il est capable de prendre des blocks et les reposer ailleurs." }, new List<string> { "apparence 1", "apparence avec un bloc" }, new List<Modèle.Conseil> { }));
            lm.Add(new Monstre(15, "Slime", "hostile", "Je connais le multiclonage !", new List<string> { "Les slimes peuvent apparaître avec des tailles différentes.", "S'il n'est pas trop petit, il se divisera en quatre."}, new List<string> { "Apparencegrand", "apparence petit"}, new List<Modèle.Conseil> { }));
            lm.Add(new Monstre(16, "Araignée", "hostile", " je sais pas quoi mettre mdrrrrr", new List<string> { "L'arraignée est capable de grimper au mur", " Si vous en rencontrait une en journée et en extérieur elle sera inoffensive, mais dans une caverne ou pendant la nuit elle vous attaquera." }, new List<string> { "une seule apparence" }, new List<Modèle.Conseil> { }));
            return lm;
        }
